"""LMDB latents dataset: precomputed VAE latents with horizontal-flip augmentation."""
...
class LMDBLatentsDataset(torch.utils.data.Dataset):
    """Precomputed VAE latents stored in LMDB.

    Each sample holds the original and horizontally-flipped moments plus a label;
    flip_prob is the probability of returning the flipped moments.
    """
